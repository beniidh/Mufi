...
import com.c.apay.Adapter.AdapterMenuUtama;
import com.c.apay.Adapter.SliderAdapter;
import com.c.apay.Api.Api;
import com.c.apay.Fragment.DirectLink.AdapterDirectLink;
import com.c.apay.Fragment.DirectLink.mDirect;
import com.c.apay.Helper.RetroClient;
import com.c.apay.Helper.utils;
import com.c.apay.Model.MBanner;
import com.c.apay.Model.ModelMenuUtama;
import com.c.apay.Model.SliderItem;
import com.c.apay.R;
import com.c.apay.Respon.ResponMenuUtama;
import com.c.apay.SaldoServer.TopupSaldoServer;
import com.c.apay.drawer_activity;
import com.c.apay.menuUtama.DirectLink.AdapterMenuDirect;
import com.c.apay.menuUtama.DirectLink.mDirectL;
import com.c.apay.sharePreference.Preference;
import com.c.apay.TopUpSaldoku.topup_saldoku_activity;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ViewModelProviders.of(getActivity()).get(HomeViewModel.class).getRunning().observe(getViewLifecycleOwner(), new Observer<String>() {
            ...
            public void onChanged(String s) {
                if (s.isEmpty()) {
                    marqueeText.setText("Selamat datang di Aplikasi Apay, maksimalkan transaksi anda");
                } else {
