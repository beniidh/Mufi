package com.c.apay.CetakStruk.StrukPLNPra;
...
import com.c.apay.CetakStruk.Epos.AsyncBluetoothEscPosPrint;
import com.c.apay.CetakStruk.Epos.AsyncEscPosPrinter;
import com.c.apay.CetakStruk.cetak;
import com.c.apay.Helper.RetroClient;
import com.c.apay.Helper.utils;
import com.c.apay.R;
import com.c.apay.Respon.ResponProfil;
import com.c.apay.databinding.ActivityCetakBankBinding;
...
public class cetakBank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.shareStrukP.setOnClickListener(v->{
            ...
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(), "com.c.apay.fileprovider", newFile);
