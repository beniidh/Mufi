...
import com.c.apay.Modal.ModalKabupaten;
import com.c.apay.Modal.ModalKecamatan;
import com.c.apay.Modal.ModalKelurahan;
import com.c.apay.Modal.ModalKodePos;
import com.c.apay.Modal.ModalProvinsi;
    ...
    public void Register(View view) {
        ...
        if (name.isEmpty()) {
            ...
            FirebaseMessaging.getInstance().getToken().addOnCompleteListener(task -> {
                ...
                MRegister register = new MRegister(name, deviceToken, Email, Phone, Store_name, MacAddres, IpAddres, alamat, parent, useragent, 0, 0, 0, 0, 0, longlitude, latitude, "SRVID00000071");
