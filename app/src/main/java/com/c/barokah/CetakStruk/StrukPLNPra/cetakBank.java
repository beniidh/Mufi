package com.c.barokah.CetakStruk.StrukPLNPra;
...
import com.c.barokah.CetakStruk.Epos.AsyncBluetoothEscPosPrint;
import com.c.barokah.CetakStruk.Epos.AsyncEscPosPrinter;
import com.c.barokah.CetakStruk.cetak;
...
import com.c.barokah.databinding.ActivityCetakBankBinding;
...
public class cetakBank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.shareStrukP.setOnClickListener(v->{
            ...
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(), "com.c.barokah.fileprovider", newFile);
