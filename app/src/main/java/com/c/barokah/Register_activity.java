...
import com.c.barokah.Modal.ModalKabupaten;
import com.c.barokah.Modal.ModalKecamatan;
import com.c.barokah.Modal.ModalKelurahan;
import com.c.barokah.Modal.ModalKodePos;
import com.c.barokah.Modal.ModalProvinsi;
    ...
    public void Register(View view) {
        ...
        if (name.isEmpty()) {
            ...
            FirebaseMessaging.getInstance().getToken().addOnCompleteListener(task -> {
                ...
                MRegister register = new MRegister(name, deviceToken, Email, Phone, Store_name, MacAddres, IpAddres, alamat, parent, useragent, 0, 0, 0, 0, 0, longlitude, latitude, "SRVID00000061");
