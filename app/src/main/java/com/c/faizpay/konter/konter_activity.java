...
import com.c.faizpay.konter.DrawSaldo.drawsaldoku;
import com.c.faizpay.konter.KirimSaldo.TransferSaldo;
import com.c.faizpay.konter.MarkupKonter.MarkupKonter;
            ...
            @Override            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.tariksaldo:
                        /*menangani saat Feedback di klik*/
                        Intent intent3 = new Intent(konter_activity.this, drawsaldoku.class);
                        intent3.putExtra("namakonter",nama);
                        intent3.putExtra("id",idd);
