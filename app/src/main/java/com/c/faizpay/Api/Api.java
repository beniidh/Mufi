package com.c.faizpay.Api;

import com.c.faizpay.CetakStruk.ResponCodeSubPS;
import com.c.faizpay.CetakStruk.ResponStruk;
import com.c.faizpay.DaftarHarga.ResponProdukDH;
import com.c.faizpay.DaftarHarga.ResponProdukList;
import com.c.faizpay.DaftarHarga.ResponSubProdukDH;
import com.c.faizpay.Fragment.DirectLink.mDirect;
import com.c.faizpay.Fragment.RekapSaldo.responRekap;
import com.c.faizpay.Fragment.Respon.MRuningText;
import com.c.faizpay.Fragment.RiwayatTransaksi.ResponTransaksi;
import com.c.faizpay.KomisiSales.ResponSales;
import com.c.faizpay.MarkUP.ResponMarkup;
import com.c.faizpay.MarkUP.markupSpesifik.ResponProdukDHM;
import com.c.faizpay.MarkUP.markupSpesifik.ResponProdukListM;
import com.c.faizpay.MarkUP.markupSpesifik.ResponSubProdukDHM;
import com.c.faizpay.MarkUP.sendMarkUP;
import com.c.faizpay.Model.MResestPIN;
import com.c.faizpay.Model.mOTP;
import com.c.faizpay.Model.mResetPassword;
import com.c.faizpay.Notifikasi.Pesan.mPesan;
import com.c.faizpay.Notifikasi.Pesan.mPesanDetail;
import com.c.faizpay.Notifikasi.ResponTransaksiN;
import com.c.faizpay.PengajuanLimit.ResponPengajuan;
import com.c.faizpay.PengajuanLimit.SendPengajuan;
import com.c.faizpay.PersetujuanSaldoSales.ResponPersetujuan;
import com.c.faizpay.PersetujuanSaldoSales.ResponPersetujuanSaldo;
import com.c.faizpay.PersetujuanSaldoSales.SendDataPersetujuan;
import com.c.faizpay.Profil.MPin;
import com.c.faizpay.Profil.MProfilEdit;
import com.c.faizpay.Profil.Poin.mExcange;
import com.c.faizpay.Profil.Poin.mReward;
import com.c.faizpay.Profil.ResEdit;
import com.c.faizpay.Respon.Respon;
import com.c.faizpay.Respon.ResponBanner;
import com.c.faizpay.Respon.ResponEditKec;
import com.c.faizpay.Respon.ResponEditLokasi;
import com.c.faizpay.Respon.ResponEditPost;
import com.c.faizpay.Respon.ResponEditkel;
import com.c.faizpay.Respon.ResponK;
import com.c.faizpay.Respon.ResponKEditKab;
import com.c.faizpay.Respon.ResponKe;
import com.c.faizpay.Respon.ResponMenu;
import com.c.faizpay.Respon.ResponMenuUtama;
import com.c.faizpay.Respon.ResponPost;
import com.c.faizpay.Respon.ResponProfil;
import com.c.faizpay.Respon.ResponResetPassword;
import com.c.faizpay.Respon.ResponResetPin;
import com.c.faizpay.Respon.ResponSubCategory;
import com.c.faizpay.Respon.ResponSubP;
import com.c.faizpay.Respon.Responkel;
import com.c.faizpay.Model.MOtpVerif;
import com.c.faizpay.Model.MRegisData;
import com.c.faizpay.Model.MRegister;
import com.c.faizpay.Model.Mlogin;
import com.c.faizpay.Model.Mphone;
import com.c.faizpay.Model.MsetPIN;
import com.c.faizpay.Model.Responphoto;
import com.c.faizpay.SaldoServer.AddUPP;
import com.c.faizpay.SaldoServer.ResponTagihanPayLatter;
import com.c.faizpay.SaldoServer.ResponUPP;
import com.c.faizpay.SaldoServer.Responn;
import com.c.faizpay.TagihanKonter.ResponApprove;
import com.c.faizpay.TagihanKonter.ResponTagihanKonter;
import com.c.faizpay.TagihanKonter.SendApprove;
import com.c.faizpay.TambahKonter.ResponTambahKonter;
import com.c.faizpay.TambahKonter.SendDataKonter;
import com.c.faizpay.TarikKomisi.ResponKomisi;
import com.c.faizpay.TarikKomisi.mKomisi;
import com.c.faizpay.TopUpSaldoku.HistoryTopUp.ResponHistory;
import com.c.faizpay.TopUpSaldoku.ReqSaldoku;
import com.c.faizpay.TopUpSaldoku.ResponTopUp;
import com.c.faizpay.TopUpSaldoku.mCancel;
import com.c.faizpay.Transaksi.MInquiry;
import com.c.faizpay.Transaksi.ResponInquiry;
import com.c.faizpay.Transaksi.mBankOption;
import com.c.faizpay.Transfer.ModelKonter;
import com.c.faizpay.Transfer.Mtransfer;
import com.c.faizpay.TagihanKonterSales.ResponTagihanKonterSales;
import com.c.faizpay.TransferBank.MTransfer;
import com.c.faizpay.TransferBank.MinquiryBank;
import com.c.faizpay.TransferBank.ModelNamaBank;
import com.c.faizpay.TransferBank.ResponBankSub;
import com.c.faizpay.TransferBank.ResponInquiryBank;
import com.c.faizpay.TransferBank.ResponTransfer;
import com.c.faizpay.konter.DrawSaldo.mDraw;
import com.c.faizpay.konter.KirimSaldo.Mtransfers;
import com.c.faizpay.konter.MRegisKonter;
import com.c.faizpay.konter.MarkupKonter.mMarkKonter;
import com.c.faizpay.konter.MarkupKonter.responMUK;
import com.c.faizpay.konter.Mkonter;
import com.c.faizpay.menuUtama.AngsuranKredit.ResponAngsuran;
import com.c.faizpay.menuUtama.AngsuranKredit.ResponProdukAngsuran;
import com.c.faizpay.menuUtama.BPJS.ResponBPJS;
import com.c.faizpay.menuUtama.DirectLink.mDirectL;
import com.c.faizpay.menuUtama.GasNegara.ResponGasnegara;
import com.c.faizpay.menuUtama.GasNegara.ResponProdukGasnegara;
import com.c.faizpay.menuUtama.HolderPulsa.ResponGroup;
import com.c.faizpay.menuUtama.HolderPulsa.ResponProdukHolder;
import com.c.faizpay.menuUtama.HolderPulsa.ResponSub;
import com.c.faizpay.menuUtama.Internet.ResponIntenet;
import com.c.faizpay.menuUtama.Internet.ResponProdukInternet;
import com.c.faizpay.menuUtama.ListrikPLN.ResponListrikPln;
import com.c.faizpay.menuUtama.ListrikPLNPasca.ResponCodeSub;
import com.c.faizpay.menuUtama.ListrikPLNPasca.ResponGetCodePasca;
import com.c.faizpay.menuUtama.ListrikPLNPasca.ResponListrikPlnPasca;
import com.c.faizpay.menuUtama.PajakPBB.ResponPajak;
import com.c.faizpay.menuUtama.PajakPBB.ResponProdukPBB;
import com.c.faizpay.menuUtama.Paket.ResponPaketData;
import com.c.faizpay.menuUtama.PaketsmsTelpon.ResponProdukSmsTelp;
import com.c.faizpay.menuUtama.PaketsmsTelpon.ResponSmsTelpon;
import com.c.faizpay.menuUtama.PulsaPascaBayar.ResponProdukSubPPasca;
import com.c.faizpay.menuUtama.PulsaPascaBayar.ResponPulsaPasca;
import com.c.faizpay.menuUtama.PulsaPrabayar.MTransaksiPraPulsa;
import com.c.faizpay.menuUtama.PulsaPrabayar.Mchek;
import com.c.faizpay.menuUtama.PulsaPrabayar.ResponPulsaPra;
import com.c.faizpay.menuUtama.PulsaPrabayar.ResponTransaksiPulsaPra;
import com.c.faizpay.menuUtama.TV.ResponProdukTV;
import com.c.faizpay.menuUtama.TV.ResponTV;
import com.c.faizpay.menuUtama.UangElektronik.ResponProdukUE;
import com.c.faizpay.menuUtama.UangElektronik.ResponUangElektronik;
import com.c.faizpay.menuUtama.Voucher.ResponProdukVoucherv;
import com.c.faizpay.menuUtama.Voucher.ResponVoucher;
import com.c.faizpay.menuUtama.VoucherGame.ResponProdukVoucher;
import com.c.faizpay.menuUtama.VoucherGame.ResponVoucherGame;
import com.c.faizpay.menuUtama.air.ResponAir;
import com.c.faizpay.menuUtama.air.ResponProdukAir;
import com.c.faizpay.reseller.ResponApproveSaldoR;
import com.c.faizpay.reseller.ResponSaldoReseller;
import com.c.faizpay.reseller.mSetujuSaldo;
