package com.c.faizpay.menuUtama.ListrikPLN;
...
import com.c.faizpay.menuUtama.PulsaPrabayar.DetailTransaksiPulsaPra;
...
public class AdapterProdukPLN extends RecyclerView.Adapter<AdapterProdukPLN.ViewHolder> {
    ...
    public AdapterProdukPLN(Context context, ArrayList<ModelProdukPln> modelProdukPlns, String nomor,String type,  Pln_Produk produk) {
