package com.c.faizpay.CetakStruk.StrukPLNPra;
...
import com.c.faizpay.CetakStruk.Epos.AsyncBluetoothEscPosPrint;
import com.c.faizpay.CetakStruk.Epos.AsyncEscPosPrinter;
import com.c.faizpay.CetakStruk.cetak;
...
import com.c.faizpay.databinding.ActivityCetakBankBinding;
...
public class cetakBank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.Harga.setText(utils.ConvertRP(getIntent().getExtras().getString("hargadasar")));
        binding.total.setText(utils.ConvertRP(getIntent().getExtras().getString("hargadasar")));
        ...
        binding.shareStrukP.setOnClickListener(v->{
            ...
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(), "com.c.faizpay.fileprovider", newFile);
    ...
    public void popUpMenuSetHargajual() {
        ...
        button2.setOnClickListener(view -> {
            ...
            int total = Integer.parseInt(editText.getText().toString()) + Integer.parseInt(getIntent().getExtras().getString("hargadasar"));
