...
import com.c.atmpay.Adapter.AdapterMenuUtama;
import com.c.atmpay.Adapter.SliderAdapter;
import com.c.atmpay.Api.Api;
import com.c.atmpay.Fragment.DirectLink.AdapterDirectLink;
...
import com.c.atmpay.Model.SliderItem;
import com.c.atmpay.R;
import com.c.atmpay.Respon.ResponMenuUtama;
import com.c.atmpay.SaldoServer.TopupSaldoServer;
import com.c.atmpay.drawer_activity;
import com.c.atmpay.menuUtama.DirectLink.AdapterMenuDirect;
import com.c.atmpay.menuUtama.DirectLink.mDirectL;
import com.c.atmpay.sharePreference.Preference;
import com.c.atmpay.TopUpSaldoku.topup_saldoku_activity;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ViewModelProviders.of(getActivity()).get(HomeViewModel.class).getRunning().observe(getViewLifecycleOwner(), new Observer<String>() {
            ...
            public void onChanged(String s) {
                if (s.isEmpty()) {
                    marqueeText.setText("Selamat datang di Aplikasi ATMPay, maksimalkan transaksi anda");
                } else {
