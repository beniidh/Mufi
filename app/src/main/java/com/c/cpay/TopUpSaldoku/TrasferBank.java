...
import com.c.cpay.R;
import com.c.cpay.TopUpSaldoku.HistoryTopUp.Activity_HistoryTopUp;
...
//                progresktp.setVisibility(View.GONE);
    ...
    private void ajukanlimitt( double amount) {
        ...
        ReqSaldoku reqSaldoku = new ReqSaldoku(Value.getMacAddress(getApplicationContext()), Value.getIPaddress(), Value.getUserAgent(getApplicationContext()), amount);
