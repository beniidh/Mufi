package com.c.cpay.CetakStruk.StrukPLNPasca;
...
import com.c.cpay.CetakStruk.Epos.AsyncBluetoothEscPosPrint;
import com.c.cpay.CetakStruk.Epos.AsyncEscPosPrinter;
import com.c.cpay.CetakStruk.cetak;
import com.c.cpay.Helper.LoadingPrimer;
...
public class CetakPlnPasca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareStrukP.setOnClickListener(v -> {
            ...
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(), "com.c.cpay.fileprovider", newFile);
