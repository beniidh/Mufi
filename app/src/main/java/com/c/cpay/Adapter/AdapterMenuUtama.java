...
import com.c.cpay.menuUtama.HolderPulsa.holder_pulsa_activity;
import com.c.cpay.menuUtama.ListrikPLN.groupPLN;
...
public class AdapterMenuUtama extends RecyclerView.Adapter<AdapterMenuUtama.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ModelMenuUtama modelMenuUtama = menuUtamas.get(position);
            Picasso.get().load(modelMenuUtama.getIcon_cpay()).into(holder.iconmenu);
