...
import com.c.rcf.Adapter.AdapterMenuUtama;
import com.c.rcf.Adapter.SliderAdapter;
import com.c.rcf.Api.Api;
import com.c.rcf.Fragment.DirectLink.AdapterDirectLink;
...
import com.c.rcf.Model.SliderItem;
import com.c.rcf.R;
import com.c.rcf.Respon.ResponMenuUtama;
import com.c.rcf.SaldoServer.TopupSaldoServer;
import com.c.rcf.drawer_activity;
import com.c.rcf.menuUtama.DirectLink.AdapterMenuDirect;
import com.c.rcf.menuUtama.DirectLink.mDirectL;
import com.c.rcf.sharePreference.Preference;
import com.c.rcf.TopUpSaldoku.topup_saldoku_activity;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ViewModelProviders.of(getActivity()).get(HomeViewModel.class).getRunning().observe(getViewLifecycleOwner(), new Observer<String>() {
            ...
            public void onChanged(String s) {
                if (s.isEmpty()) {
                    marqueeText.setText("Selamat datang di Aplikasi Bintang Timur, maksimalkan transaksi anda");
                } else {
