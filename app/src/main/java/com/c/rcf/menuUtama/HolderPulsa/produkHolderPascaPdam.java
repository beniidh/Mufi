package com.c.rcf.menuUtama.HolderPulsa;
...
public class produkHolderPascaPdam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterProdukHolder = new AdapterProdukHolderP(getApplicationContext(), produk, inputnomorproduk.getText().toString(), produkHolderPascaPdam.this);
    ...
    private void getProduk(String id) {
        ...
        LoadingPrimer loadingPrimer = new LoadingPrimer(produkHolderPascaPdam.this);
        ...
        call.enqueue(new Callback<ResponProdukHolder>() {
            ...
            public void onResponse(Call<ResponProdukHolder> call, Response<ResponProdukHolder> response) {
                ...
                if (code.equals("200")) {
                    ...
                    adapterProdukHolder = new AdapterProdukHolderP(getApplicationContext(), produk,  Preference.getNo(getApplicationContext()), produkHolderPascaPdam.this);
                    ReyProdukHolder.setAdapter(adapterProdukHolder);
