...
public class produkholder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterProdukHolder = new AdapterProdukHolder(getApplicationContext(), produk, inputnomorproduk.getText().toString(),produkholder.this);
        ...
        call.enqueue(new Callback<ResponProdukHolder>() {
            ...
            public void onResponse(Call<ResponProdukHolder> call, Response<ResponProdukHolder> response) {
                ...
                if (code.equals("200")) {
                    ...
                    adapterProdukHolder = new AdapterProdukHolder(getApplicationContext(), produk, Preference.getNo(getApplicationContext()),produkholder.this);
                    ReyProdukHolder.setAdapter(adapterProdukHolder);
