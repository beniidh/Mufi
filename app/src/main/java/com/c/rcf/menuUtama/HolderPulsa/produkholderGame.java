...
public class produkholderGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterProdukHolder = new AdapterProdukHolder(getApplicationContext(), produk, inputnomorproduk.getText().toString(),produkholderGame.this);
    ...
    private void getProdukSub(String id) {
        LoadingPrimer loadingPrimer = new LoadingPrimer(produkholderGame.this);
        ...
        call.enqueue(new Callback<ResponProdukHolder>() {
            ...
            public void onResponse(Call<ResponProdukHolder> call, Response<ResponProdukHolder> response) {
                ...
                if (code.equals("200")) {
                    ...
                    adapterProdukHolder = new AdapterProdukHolder(getApplicationContext(), produk, Preference.getNo(getApplicationContext()),produkholderGame.this);
                    ReyProdukHolder.setAdapter(adapterProdukHolder);
