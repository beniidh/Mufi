...
import com.c.rcf.Helper.GpsTracker;
import com.c.rcf.Helper.RetroClient;
import com.c.rcf.Helper.utils;
import com.c.rcf.Modal.ModalKabupaten;
import com.c.rcf.Modal.ModalKecamatan;
import com.c.rcf.Modal.ModalKelurahan;
import com.c.rcf.Modal.ModalKodePos;
import com.c.rcf.Modal.ModalProvinsi;
    ...
    public void Register(View view) {
        ...
        if (name.isEmpty()) {
            ...
            FirebaseMessaging.getInstance().getToken().addOnCompleteListener(task -> {
                ...
                MRegister register = new MRegister(name, deviceToken, Email, Phone, Store_name, MacAddres, IpAddres, alamat, parent, useragent, 0, 0, 0, 0, 0, longlitude, latitude, "SRVID00000069");
